...
Откройте в браузере: `http://89.111.152.163`

API доступен по адресу: `http://89.111.152.163/api`
...
Откройте `http://89.111.152.163:9000` для визуального мониторинга:
