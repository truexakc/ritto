...
const NotFound = () => {
    return (
        <div className="relative min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#1a1a1a] to-[#0c0c0c] overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-[#e8262b]/10 rounded-full blur-2xl"></div>
            ...
            <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center">
                ...
                >
                    ...
                    >
                        <h1 className="text-8xl lg:text-9xl font-black bg-gradient-to-r from-[#e8262b] to-[#d12025] bg-clip-text text-transparent">
                            404
                        </h1>
                        
                        {/* Декоративные элементы вокруг числа */}
                        <div className="absolute -top-4 -right-4 w-8 h-8 bg-[#e8262b] rounded-full opacity-20"></div>
                        <div className="absolute -bottom-2 -left-4 w-6 h-6 bg-[#e8262b] rounded-full opacity-30"></div>
                        <div className="absolute top-1/2 -right-8 w-4 h-4 bg-[#e8262b] rounded-full opacity-40"></div>
                    </motion.div>
                    ...
                    >
                        <div className="w-20 h-20 bg-white/5 rounded-2xl flex items-center justify-center mx-auto border border-white/10">
                            <Search className="w-10 h-10 text-[#e8262b]" />
                        </div>
                    </motion.div>
                    ...
                    >
                        <Link to="/">
                            <motion.button
                                className="group bg-[#e8262b] hover:bg-[#d12025] text-white font-bold rounded-2xl px-8 py-4 shadow-2xl hover:shadow-3xl transition-all duration-300 flex items-center gap-3"
                    ...
                    >
                        ...
                        <div className="flex justify-center gap-4">
                            <a 
                                ...
                                className="text-[#e8262b] hover:text-[#d12025] text-sm font-medium transition-colors"
                            >
                                +7 (900) 000-00-00
                            </a>
                ...
                <div className="absolute inset-0 pointer-events-none overflow-hidden">
                    {[...Array(20)].map((_, i) => (
                        <motion.div
                            key={i}
                            className="absolute w-2 h-2 bg-[#e8262b] rounded-full opacity-20"
                            initial={{
